...
class AccRecoIsoEffs
{
 public:
  ...
  int nevents_cs_els = 0;
  int nevents_cs_mus_sb[NSEARCH_BINS] = {0};
  int nevents_cs_els_sb[NSEARCH_BINS] = {0};
  ...
  double nevents_els_pred_iso_SB_Normalized[NSEARCH_BINS] = {0}, nevents_els_pred_reco_SB_Normalized[NSEARCH_BINS] = {0}, nevents_els_pred_acc_SB_Normalized[NSEARCH_BINS] = {0};
...
class ClosureHistgram
{
 public:
  ...
  TH2D *h_pred_lept_all_2d_met_mupt, *h_pred_lept_all_2d_met_elpt;
...
void ClosureHistgram::BookHistgram(const char *outFileName)
{
  ...
  h_pred_lept_all_2d_met_elpt = new TH2D("h_pred_lept_all_2d_met_elpt","",100,-10,10,100,0,100);
